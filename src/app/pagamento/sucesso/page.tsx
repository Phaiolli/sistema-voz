  ...
  return (
    <main className="flex min-h-[100dvh] flex-col items-center justify-center gap-8 bg-background p-8">
      ...
      <div className="flex max-w-md flex-col items-center gap-4 text-center">
        <span
          aria-hidden="true"
          className="flex h-16 w-16 items-center justify-center rounded-full bg-accent text-accent-foreground text-[28px]"
        >
          ✓
        </span>
        ...
        <p className="m-0 text-base leading-[1.6] text-muted-foreground">
          Seu evento será criado em instantes. Verifique seu dashboard.
        </p>
